# This script creates the target curves of ABF and CAZ, that would be use for the analysis in script High_to_Low_stress.R
...
fw_stress_matrix <- fw_stress_matrix[, -ncol(fw_stress_matrix)] #Remove last column
...
# Files have been created that will be used in the R script 2_High_to_Low_stress.R to calculate the surrogacy.